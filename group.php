...
if (isset($_POST['code']) && $_SESSION['moder']>0)
{
$query=sprintf("UPDATE $userstable SET  code='%s' WHERE id='%s'", mysql_real_escape_string($_POST['code']), mysql_real_escape_string($_GET['id']));
...
$query=sprintf("SELECT id, code, speciality FROM $userstable WHERE id='%s'",
...
mysql_real_escape_string($row['speciality']));
...
mysql_real_escape_string($grow['department']));
...
echo '<table style="margin-left:10%;"><tr><td width="5%" valign="top"><img src="arrow.png" style="width: 100%;"></td><td width="74%"><div><a href="speciality.php?id='.$grow['id'].'" style="text-decoration:none;"><div class="lightitem">'.$grow['shortname'].'</div></a></div></td><td width="20%"><td></tr></table>';


echo '<table style="margin-left:15%;"><tr><td width="5%" valign="top"><img src="arrow.png" style="width: 100%;"></td><td width="77%"><div><a href="group.php?id='.$row['id'].'" style="text-decoration:none;"><div class="lightitem">'.$row['code'].'</div></a></div></td><td width="20%"><td></tr></table>';
...
<form method="post" id="panel" style="display:none;" action="group.php?id=<?php echo $_GET['id']; ?>" class="medtext" enctype="multipart/form-data">
...
echo '<iframe id="idIframe" onload="iframeLoaded()" src="students.php?groupid='.$_GET['id'].'" style="width:120%; border: none;" ></iframe>';
