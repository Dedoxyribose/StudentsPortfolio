...
$query=sprintf("SELECT * FROM comments, prepods WHERE `comments`.id='%s' AND `comments`.author=`prepods`.username", mysql_real_escape_string($_GET['id']));
